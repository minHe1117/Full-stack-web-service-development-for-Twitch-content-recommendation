...
public class ApplicationConfig {
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "laiproject-instance.cfjyd9fcotis.us-east-2.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "Hm6210113$";
        //需要修改红色部分, 保留其他内容,  YOUR_RDS_INSTANCE_ADDRESS,USERNAME,  PA    SSWORD are information created last lesson
